	...
	<table style="padding: 5px" width="100%">
		<tr>
			...
			<td style="padding-top: 16px" valign="middle" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>Freedom</font>
			</td>
		</tr>
	</table>
</div>
...
<div id="dlg" class="easyui-dialog" style="width: 400px;height: 200px;padding: 10px 20px" closed="true" buttons="#dlg-button">
